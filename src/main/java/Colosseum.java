...
public class Colosseum {
    ...
    public static Pokemon buildPokemon() {
        ...
        System.out.println("Please name your Pokeman: ");
        name = myScan.next();
        ...
        while (attackLevel > 49 || attackLevel < 1) {
            System.out.println("The attack level must be between 1 and 49: ");
            attackLevel = myScan.nextInt();
        }
        tempPokemon.attackLevel = attackLevel;

        int maxDefense = 50 - attackLevel;
        System.out.println("Enter your defense level (1-" + maxDefense + ")");

        defenseLevel = myScan.nextInt();

        while (defenseLevel < 1 || defenseLevel > maxDefense) {
    ...
    public static void printWhoIsAhead() {
        if (firstPokemon.hitPoints > secondPokemon.hitPoints) {
            ...
            System.out.println("IT'S TIE NOW WORK HARDER GUYS!!!!");
        }
    }
